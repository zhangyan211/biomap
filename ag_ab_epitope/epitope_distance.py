...
csv_path = '/nfs_beijing/kubeflow-user/zhangyan_2023/test_distance.csv'
...
def process_epitope(np_exsamples, data_items):
    for row in data_items:
        ...
        # if True:
            ...
            residue_index = ag_residue_index
            ...
            for i in range(len(chain_ids)):
                ...
                for cutoff in [4.5]:
                    ...
                    epitope = torch.gather(torch.Tensor(residue_index), 0, epitope).long().tolist()
...
print(df)
df.to_csv('fv_159_v3_test_epitope.csv')